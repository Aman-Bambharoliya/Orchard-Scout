jQuery(document).ready(function () {
    ...
    $('.checkbox1').click(function () {
        if ($(this).is(':checked')) {
            $(this).parent().parent().parent().parent().siblings('div').find(':checkbox').prop('checked', this.checked);
        }
        else {
            $(this).parent().parent().parent().parent().siblings('div').find(':checkbox').prop('checked', false);
        }
    })

    $('.subcheck').on('change', function () {
        var total_option = $(this).parent().parent().parent().parent().parent().find('input.subcheck').length;
        var checked_option = $(this).parent().parent().parent().parent().parent().find('input.subcheck:checked').length;
        if (total_option == checked_option) {
            $(this).parent().parent().parent().parent().parent().find('input.checkbox1').prop('checked', this.checked);
        } else {
            $(this).parent().parent().parent().parent().parent().find('input.checkbox1').prop('checked', false);
        }
    })
});
