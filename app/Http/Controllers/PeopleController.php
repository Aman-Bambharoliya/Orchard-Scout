            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function (People $data) {
                    ...
                    if ($user_data->hasPermission('peoples', 'update')) {
                        $edit_button .= '<a href="' . route('peoples.edit', $data->id) . '" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                    ...
                    if ($user_data->hasPermission('peoples', 'delete')) {
                        $delete_button .= '<a href="#" data-id="' . route('peoples.destroy', $data->id) . '" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm me-1 delete_record">
                        <span class="svg-icon svg-icon-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
