	...
	<div class="aside-menu flex-column-fluid">
		<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
			<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
				...
				@endpermission
				@permission('vendors')
				<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if (Route::currentRouteName() == 'vendors.index' || Route::currentRouteName() == 'vendors.create' || Route::currentRouteName() == 'vendors.edit' || Route::currentRouteName() == 'vendor-addresses.index' || Route::currentRouteName() == 'vendor-addresses.create' || Route::currentRouteName() == 'vendor-addresses.edit') here hover show @endif">
					<span class="menu-link">
						<span class="menu-icon">
							<span class="svg-icon svg-icon-2">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<div class="menu-sub menu-sub-accordion">
						...
						<div class="menu-item">
							<a class="menu-link  @if (Route::currentRouteName() == 'vendors.create') active @endif" href="{{route('vendors.create')}}">
								<span class="menu-bullet">
									<span class="bullet bullet-dot"></span>
								</span>
								<span class="menu-title">{{__('Add')}}</span>
						...
						<div class="menu-item">
							<a class="menu-link @if (Route::currentRouteName() == 'vendors.index' || Route::currentRouteName() == 'vendors.edit' || Route::currentRouteName() == 'vendor-addresses.index' || Route::currentRouteName() == 'vendor-addresses.create' || Route::currentRouteName() == 'vendor-addresses.edit') active @endif" href="{{route('vendors.index')}}">
								<span class="menu-bullet">
									<span class="bullet bullet-dot"></span>
								</span>
								<span class="menu-title">{{__('List')}}</span>
				...
				<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if (Route::currentRouteName() == 'crop-locations.index' || Route::currentRouteName() == 'crop-locations.create' || Route::currentRouteName() == 'crop-locations.edit') here hover show @endif">
					<span class="menu-link">
						<span class="menu-icon">
							<span class="svg-icon svg-icon-2">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<div class="menu-sub menu-sub-accordion">
						...
						<div class="menu-item">
							<a class="menu-link  @if (Route::currentRouteName() == 'crop-locations.create') active @endif" href="{{route('crop-locations.create')}}">
								<span class="menu-bullet">
									<span class="bullet bullet-dot"></span>
								</span>
								<span class="menu-title">{{__('Add')}}</span>
