    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @superadmin
                        <div class="menu-item">
                            <a class="menu-link  @if (Route::currentRouteName() == 'admin-users.index' ||
                            Route::currentRouteName() == 'admin-users.create' ||
                            Route::currentRouteName() == 'admin-users.edit') active @endif"
                                href="{{ route('admin-users.index') }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                data-bs-placement="right">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                @permission('address-types', 'index')
                        <div class="menu-item">
                            <a class="menu-link @if (Route::currentRouteName() == 'address-types.index' ||
                            Route::currentRouteName() == 'address-types.create' ||
                            Route::currentRouteName() == 'address-types.edit') active @endif"
                ...
                @permission('customers', 'index')
                             <div class="menu-item">
                                ...
                                Route::currentRouteName() == 'customer-peoples.create' ||
                                Route::currentRouteName() == 'customer-peoples.edit' ||
                                Route::currentRouteName() == 'customer-peoples.index' ||
                                Route::currentRouteName() == 'customer-phones.index' ||
                                Route::currentRouteName() == 'customer-phones.edit' ||
                                Route::currentRouteName() == 'customer-phones.create' ||
                ...
                @endpermission
                 @permission('crop-commodity-types', 'index')
                            ...
                            @permission('crop-locations', 'index')
                                <div class="menu-item">
                                    <a class="menu-link @if (Route::currentRouteName() == 'crop-locations.index' ||
                                    Route::currentRouteName() == 'crop-locations.create' ||
                                    Route::currentRouteName() == 'crop-locations.edit') active @endif"
                            ...
                            @permission('vendors', 'index')
                                <div class="menu-item">
                                    ...
                                    Route::currentRouteName() == 'vendor-peoples.create' ||
                                    Route::currentRouteName() == 'vendor-peoples.edit' ||
                                    Route::currentRouteName() == 'vendor-peoples.index' ||
                                    Route::currentRouteName() == 'vendor-phones.create' ||
                                    Route::currentRouteName() == 'vendor-phones.edit' ||
                                    Route::currentRouteName() == 'vendor-phones.index' ||
                      ...
                      @permission('scout-reports', 'index') 
                         <div class="menu-item">
                             ...
                             Route::currentRouteName() == 'scout-reports.edit') active @endif"
                                 href="{{ route('scout-reports.index') }}">
                                 <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
